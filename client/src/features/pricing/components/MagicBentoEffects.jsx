...
const DEFAULT_GLOW_COLOR = '249, 115, 22'; // pricing-page accent orange
...
const updateCardGlowProperties = (card, mouseX, mouseY, glow, radius) => {
  ...
  card.style.setProperty('--mb-glow-intensity', glow.toString());
  card.style.setProperty('--mb-glow-radius', `${radius}px`);
};

/** Card wrapper: border glow + drifting particles + optional tilt/magnetism/click ripple */
export function ParticleCard({
  ...
  return (
    <div
      ...
      style={{ ...style, position: 'relative', overflow: 'hidden', '--mb-glow-color': glowColor }}
    >
      {children}
    </div>
  );
...
/** Cursor-following ambient spotlight, scoped to nearest .mb-section ancestor of gridRef */
...
export { DEFAULT_GLOW_COLOR, DEFAULT_SPOTLIGHT_RADIUS, DEFAULT_PARTICLE_COUNT };