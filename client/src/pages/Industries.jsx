  ...
  return (
    <div className="industries-page-wrapper">
      ...
      <section className="hero-section" style={{ position: 'relative', minHeight: '600px', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '10%', right: '15%', width: '12px', height: '12px', borderRadius: '50%', background: '#5B7FFF', opacity: 0.8 }} />
        <div style={{ position: 'absolute', top: '20%', right: '8%', width: '8px', height: '8px', borderRadius: '50%', background: '#FF6B6B', opacity: 0.6 }} />
        <div style={{ position: 'absolute', top: '35%', right: '25%', width: '10px', height: '10px', borderRadius: '50%', background: '#10B981', opacity: 0.7 }} />
        <div style={{ position: 'absolute', bottom: '25%', right: '10%', width: '14px', height: '14px', borderRadius: '50%', background: '#F2701E', opacity: 0.6 }} />
        <div style={{ position: 'absolute', bottom: '15%', right: '35%', width: '6px', height: '6px', borderRadius: '50%', background: '#9F7AEA', opacity: 0.8 }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div>
              <div className="eyebrow-badge" style={{ marginBottom: '2rem', display: 'inline-block', background: '#E3F2FF', padding: '0.6rem 1.2rem', borderRadius: '20px', color: '#1E40AF', fontWeight: 600, fontSize: '0.85rem', letterSpacing: '0.5px' }}>
                <span className="badge-pulse" style={{ background: '#1E40AF', marginRight: '0.5rem' }} />
            ...
            <div style={{ position: 'relative', height: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: '6px', alignItems: 'flex-end' }}>
                  <div style={{ width: '4px', height: '20px', background: '#5B7FFF', borderRadius: '2px' }} />
                  <div style={{ width: '4px', height: '30px', background: '#5B7FFF', borderRadius: '2px' }} />
                  <div style={{ width: '4px', height: '35px', background: '#5B7FFF', borderRadius: '2px' }} />
                  <div style={{ width: '4px', height: '30px', background: '#5B7FFF', borderRadius: '2px' }} />
                  <div style={{ width: '4px', height: '20px', background: '#5B7FFF', borderRadius: '2px' }} />
                </div>
              </div>
      ...
      {/* 3. Industry Feature Showcase Cards */}
