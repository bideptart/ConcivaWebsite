 ...
 * Previously duplicated verbatim across Features.jsx and FeaturesHero.jsx.
 * Unused icons (Mic, MessageSquare, Mail, Search, Check, Bot, Database,
 * Activity, Share2, Globe, Lock, ChevronDown) were removed.
 */
const Icons = {
  Sparkles: () => (
  ...
  Flask: () => (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M10 2v7.31l-5.2 8.66A2 2 0 0 0 6.5 21h11a2 2 0 0 0 1.7-3.03L14 9.31V2" />
      <path d="M8.5 2h7" /><path d="M6 15h12" />
    </svg>
  ),
  Antenna: () => (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
